...
def main():
    ...
    for i in range(i64ResultCount):
        ...
        print("    Radius1    : {:.2f}".format(matchResult.fleResultObject.radius1))
        print("    Radius2    : {:.2f}".format(matchResult.fleResultObject.radius2))
        print("  2. Score : {:.2f}\n  3. Angle : {:.2f}\n  4. Scale : {:.2f}\n".format(matchResult.f32Score, matchResult.f32Angle, matchResult.f32Scale))
        ...
        strText = "Score : {:.2f}\nAngle : {:.2f}\nScale : {:.2f}\nPivot : ({:.2f}, {:.2f})".format(matchResult.f32Score, matchResult.f32Angle, matchResult.f32Scale, matchResult.flpPivot.x, matchResult.flpPivot.y)
