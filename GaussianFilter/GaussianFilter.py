...
def main():
	...
	while True:
		...
		gaussianFilter.SetSourceImage(listFliImage[int(EType.Source)])
		# Source ROI 설정 // Set the Source ROI
		gaussianFilter.SetSourceROI(flrROI)

		# Destination1 이미지 설정 // Set the destination1 image
		gaussianFilter.SetDestinationImage(listFliImage[int(EType.Destination1)])
		...
		gaussianFilter.SetDestinationImage(listFliImage[int(EType.Destination2)])
		...
		gaussianFilter.SetDestinationImage(listFliImage[int(EType.Destination3)])
		...
		gaussianFilter.SetDestinationImage(listFliImage[int(EType.Destination4)])
