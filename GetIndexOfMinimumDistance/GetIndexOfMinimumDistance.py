...
def main():
    ...
    while True:
        ...
        Dst1Layer0.DrawTextCanvas(CFLPoint[Double](0, 20), "Index of Minimum Distance", EColor.CYAN, EColor.BLACK)
        Dst2Layer0.DrawTextCanvas(CFLPoint[Double](0, 20), "Index of Minimum Distance", EColor.CYAN, EColor.BLACK)
        ...
        if (res := flpaSource1.GetIndexOfMinimumDistance(flcDestination1, flfaResultSrc1))[0].IsFail():
        ...
        if (res := flfaSource2.GetIndexOfMinimumDistance(flfaDestination2, flfaResultSrc2, True, True, flfaResultDst2))[0].IsFail():
            ErrorPrint(res[0], "Failed to process.")
            break
