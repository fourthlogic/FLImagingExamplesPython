...
def main():
	...
	while True:
		...
		# Mean Curvature Flow 객체 생성 // Create Mean Curvature Flow object
		meanCurvatureFlowWeighted = CMeanCurvatureFlowWeighted()

		# Source 이미지 설정 // Set the source image
		meanCurvatureFlowWeighted.SetSourceImage(fliSourceImage)

		# Destination 이미지 설정 // Set the destination image
		meanCurvatureFlowWeighted.SetDestinationImage(fliDestinationImage)
		...
		if (res := meanCurvatureFlowWeighted.Execute()).IsFail():
			ErrorPrint(res, 'Failed to execute Mean Curvature Flow.')
			break
