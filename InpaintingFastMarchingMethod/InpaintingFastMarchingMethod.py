...
def main():
	...
	while True:
		...
		if (res := fliSourceImage.Load('../../ExampleImages/InpaintingFastMarchingMethod/monkey.flif')).IsFail():
		...
		# Inpainting Fast Marching Method 객체 생성 # Create Inpainting Fast Marching Method object
		inpaintingFastMarchingMethod = CInpaintingFastMarchingMethod()

		# Source 이미지 설정 # Set the source image
		inpaintingFastMarchingMethod.SetSourceImage(fliSourceImage)

		# Destination 이미지 설정 # Set the destination image
		inpaintingFastMarchingMethod.SetDestinationImage(fliDestinationImage)
		...
		if (res := inpaintingFastMarchingMethod.Execute()).IsFail():
			ErrorPrint(res, 'Failed to execute Inpainting Fast Marching Method.')
			break
