...
def main():
	...
	while True:
		...
		# Geometric Mean Filter 객체 생성 // Create Geometric Mean Filter object
		geometricMeanFilter = CGeometricMeanFilter()

		# Source 이미지 설정 // Set the source image
		geometricMeanFilter.SetSourceImage(fliSourceImage)
