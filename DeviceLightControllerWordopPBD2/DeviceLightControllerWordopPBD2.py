...
def main():
	...
	lightController = CDeviceLightControllerWordopPBD2()
	...
	while True:
		...
		eConnectionMethod = CDeviceLightControllerWordopPBD2.EConnectionMethod.RS232C

		if i32ConnectionType == 2:
			eConnectionMethod = CDeviceLightControllerWordopPBD2.EConnectionMethod.TCPServer
		elif i32ConnectionType == 3:
			eConnectionMethod = CDeviceLightControllerWordopPBD2.EConnectionMethod.TCPClient
		elif i32ConnectionType == 4:
			eConnectionMethod = CDeviceLightControllerWordopPBD2.EConnectionMethod.UDP
		...
		eLightChannel = CDeviceLightControllerWordopPBD2.ELightChannel.Port_4

		if i32ChannelCount == 2 :
			eLightChannel = CDeviceLightControllerWordopPBD2.ELightChannel.Port_6
		...
		while True:
			...
			if i32OperationMode == 4:
				...
				while True:
					...
					print("4. Rising Edge")
					print("5. Internal High Level")
					print("6. Internal Rising Edge")
					print("7. Constantly On")
					print("0. Exit")
					...
					if strInput.isdigit():
						...
						if not (i32TriggerMethod >= 0 and i32TriggerMethod <= 7):
							print("Incorrect input. Please select again.")
							continue
