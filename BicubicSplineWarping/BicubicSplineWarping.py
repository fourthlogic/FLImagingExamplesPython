...
def main():
	...
	while True:
		...
		if (res := fliSourceImage[0].Load('../../ExampleImages/BicubicSplineWarping/chess.flif')).IsFail():
		...
		# Bicubic Spline Warping 객체 생성 # Create Bicubic Spline Warping object
		bilinearSplineWarping = CBicubicSplineWarping()
		...
		bilinearSplineWarping.SetInterpolationMethod(EInterpolationMethod.Bicubic)
