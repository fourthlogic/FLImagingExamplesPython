...
def main():
	...
	# HIK 카메라 선언 // Declare the HIK camera
	camHik = CDeviceCameraHIK()
	...
	while True:
		...
		if(bAutoDetect):
			...
			if(eDeviceType == CDeviceGenICamTypeBase.EDeviceType.GigE):
				er = camHik.GetAutoDetectGigECameraSerialNumbers(listSerialNumbers)
			elif(eDeviceType == CDeviceGenICamTypeBase.EDeviceType.IEEE1394):
				er = camHik.GetAutoDetectIEEE1394CameraSerialNumbers(listSerialNumbers)
			elif(eDeviceType == CDeviceGenICamTypeBase.EDeviceType.USB):
				er = camHik.GetAutoDetectUSBCameraSerialNumbers(listSerialNumbers)
			elif(eDeviceType == CDeviceGenICamTypeBase.EDeviceType.CameraLink):
				er = camHik.GetAutoDetectCameraLinkCameraSerialNumbers(listSerialNumbers)
		...
		if(bAutoDetect):
			...
			if(eDeviceType == CDeviceGenICamTypeBase.EDeviceType.GigE):
				er = camHik.AutoDetectGigECamera(i32SelectDevice)
			elif(eDeviceType == CDeviceGenICamTypeBase.EDeviceType.IEEE1394):
				er = camHik.AutoDetectIEEE1394Camera(i32SelectDevice)
			elif(eDeviceType == CDeviceGenICamTypeBase.EDeviceType.USB):
				er = camHik.AutoDetectUSBCamera(i32SelectDevice)
			elif(eDeviceType == CDeviceGenICamTypeBase.EDeviceType.CameraLink):
				er = camHik.AutoDetectCameraLinkCamera(i32SelectDevice)
