...
class CDeviceEventSocketClientASCIIEx(CDeviceEventSocketASCII):
    ...
    def __init__(self):
        ...
        self.RegisterOnConnected(CDeviceEventSocketClientASCIIEx.Delegate_OnConnected(self.OnConnected))
...
def main():
        ...
        deviceSocketServerASCII.EnableStx(False)
        deviceSocketServerASCII.EnableEtx(False)
        deviceSocketClientASCII.EnableStx(False)
        deviceSocketClientASCII.EnableEtx(False)
