...
def main():
	...
	while True:
		...
		if (res := fliSourceImage.Load('../../ExampleImages/OperationLesser/block.flif')).IsFail():
			ErrorPrint(res, 'Failed to load the image file.')
			break
		
		# Operand 이미지 로드 # Load the operand image
		if (res := fliOperandImage.Load('../../ExampleImages/OperationLesser/road.flif')).IsFail():
			ErrorPrint(res, 'Failed to load the image file.')
			break
		...
		operationGreater.SetOperandImage(fliOperandImage)
