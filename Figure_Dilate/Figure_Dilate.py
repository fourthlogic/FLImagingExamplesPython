...
def main():
    ...
    while True:
        ...
        layer[1].DrawTextCanvas(CFLPoint[Int32](0, 0), "Dilate Result1", EColor.YELLOW, EColor.BLACK, 30)
        layer[2].DrawTextCanvas(CFLPoint[Int32](0, 0), "Dilate Result2", EColor.YELLOW, EColor.BLACK, 30)
        layer[3].DrawTextCanvas(CFLPoint[Int32](0, 0), "Dilate Result2", EColor.YELLOW, EColor.BLACK, 30)
        ...
        res, flfaResult1 = flrgSourceFig.Dilate(i64KernelSize, i64KernelSize, flfaResult1)
        ...
        res, flfaResult2 = flrgSourceFig.Dilate(i64KernelSize, i64KernelSize, flfaResult2, EKernelShape.Circle)
        ...
        res, flfaResult3 = flrgSourceFig.Dilate(fleKernel, flfaResult3)
