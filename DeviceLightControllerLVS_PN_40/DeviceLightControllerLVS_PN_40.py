...
def main():
    ...
    lightControllerLVS_PN_40 = CDeviceLightControllerLVS_PN_40()
    ...
    while True:  # do ~ while 구조 // do-while loop structure
        ...
        if portNumber.isdigit():
            ...
            lightControllerLVS_PN_40.SetComPortNumber(int(portNumber))
        ...
        if baudRate.isdigit():
            ...
            lightControllerLVS_PN_40.SetBaudRate(int(baudRate))

        if (res := lightControllerLVS_PN_40.Initialize()).IsFail():
    ...
    if (res := lightControllerLVS_PN_40.Terminate()).IsFail():
