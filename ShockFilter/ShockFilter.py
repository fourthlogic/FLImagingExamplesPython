...
def main():
	...
	while True:
		...
		if (res := fliSourceImage.Load('../../ExampleImages/ShockFilter/ShockFilter.flif')).IsFail():
		...
		# 객체 생성 // Create object
		shockFilter = CShockFilter()

		# Source 이미지 설정 // Set the source image
		shockFilter.SetSourceImage(fliSourceImage)

		# Destination 이미지 설정 // Set the destination image
		shockFilter.SetDestinationImage(fliDestinationImage)
