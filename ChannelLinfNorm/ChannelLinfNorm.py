...
def main():
	...
	while True:
		...
		channelLinfNorm = CChannelLinfNorm()
		
		if (res := channelLinfNorm.SetSourceImage(fliSrcImage)[0]).IsFail():
			break
		if (res := channelLinfNorm.SetDestinationImage(fliDstImage)[0]).IsFail():
			break
