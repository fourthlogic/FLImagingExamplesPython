...
def main():
	...
	while True:
		...
		tiltedFocusPlaneScanReparameterization3D = CTiltedFocusPlaneScanReparameterization3D()

		# Source 이미지 설정 # Set the source image
		tiltedFocusPlaneScanReparameterization3D.SetSourceImage(fliSourceImage)
