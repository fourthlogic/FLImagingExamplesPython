...
def main():
    ...
    qrcodeVerifier = CMicroQRCodeVerifier()
    ...
    for i in range(i64Results):
        # MicroQRCode Verifier 결과를 얻어오기 위해 FLQuadD 선언 # Declare FLQuadD to retrieve the result from the MicroQRCode Verifier.
        flqRegion = CFLQuad[Double]()

        # MicroQRCode Verifier 결과들 중 Data Region 을 얻어옴 # Gets the Data Region from the MicroQRCode Verifier results.
        ...
        # MicroQRCode Verifier 결과들 중 Decoded String 을 얻어옴 # Gets the decoded string from the results of the MicroQRCode Verifier.
        ...
        printQuality = CMicroQRCodePrintQuality_ISOIEC_15415()
