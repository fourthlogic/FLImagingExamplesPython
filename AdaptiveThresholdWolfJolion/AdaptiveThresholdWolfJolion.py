...
def main():
	...
	while True:
		...
		adaptiveThresholdWolfJolion = CAdaptiveThresholdWolfJolion()

		# Source 이미지 설정 # Set source image 
		adaptiveThresholdWolfJolion.SetSourceImage(fliSrcImage)

		# Destination 이미지 설정 # Set destination image
		adaptiveThresholdWolfJolion.SetDestinationImage(fliDstImage)

		# 커널 사이즈 입력 # Set Kernel size 
		adaptiveThresholdWolfJolion.SetKernel(25, 25)

		# 임계값 옵셋 설정 # Set threshold offset 
		adaptiveThresholdWolfJolion.SetThresholdOffset(CMultiVar[Double](5))
