...
def main():
	...
	while True:
		...
		if (res := viewImageSource.SynchronizeWindow(viewImageDestination0)[0]).IsFail() or (res := viewImageSource.SynchronizeWindow(viewImageDestination1)[0]).IsFail() or True:
