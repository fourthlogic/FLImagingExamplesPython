...
def main():
	...
	while True:
		...
		sCount.bCopyOriginalVertices = True;
		alg.AddPredefinedObject(sCount, EPredefinedObject.Regular_DodecaHedron, TPoint3[Byte](255, 255, 255));
		sCount.bCopyOriginalVertices = False;

		sCount.i64Edges = 4000;
		alg.AddPredefinedObject(sCount, EPredefinedObject.Regular_DodecaHedron, TPoint3[Byte](255, 0, 0));
		sCount.i64Edges = 0;

		sCount.i64Faces = 20000;
		alg.AddPredefinedObject(sCount, EPredefinedObject.Regular_DodecaHedron, TPoint3[Byte](0, 255, 0));
		sCount.i64Faces = 0;

		sCount.i64Interiors = 100000;
		alg.AddPredefinedObject(sCount, EPredefinedObject.Regular_DodecaHedron, TPoint3[Byte](0, 0, 255));
		sCount.i64Interiors = 0;
