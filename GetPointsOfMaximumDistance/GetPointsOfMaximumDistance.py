...
def main():
    ...
    while True:
        ...
        Dst1Layer0.DrawTextCanvas(CFLPoint[Double](0, 20), "Maximum Distance", EColor.CYAN, EColor.BLACK)
        ...
        Dst1Layer0.DrawTextImage(fllMax1.GetCenter(), f"{f64MaximumDistance1:.3f}", EColor.CYAN, EColor.BLACK, 12, False, 0.0, EGUIViewImageTextAlignment.RIGHT_TOP)
        ...
        Dst2Layer0.DrawTextImage(fllMax2.GetCenter(), f"{f64MaximumDistance2:.3f}", EColor.CYAN, EColor.BLACK, 12, False, 0.0, EGUIViewImageTextAlignment.LEFT_BOTTOM)
