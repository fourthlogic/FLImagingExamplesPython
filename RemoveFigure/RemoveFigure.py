...
def main():
    ...
    while True:
        ...
        strExpression1 = "vertexcount > 1 or area > 400 or (center.x > 300 or center.y < 100)"

        strForDraw = "vertexcount > 1 or area > 400\n or (center.x > 300 or center.y < 100)"

        # 조건식을 View에 표기 // Draw the conditional expression in the View
        Dst1Layer0.DrawTextCanvas(CFLPoint[Double](0, 20), strForDraw, EColor.YELLOW, EColor.BLACK, 13)

        # Source Figure 원본을 복사 // Copy Source Figure original
        flfaResult1 = CFLFigureArray(flfaSource1)
        ...
        # Source Figure 원본을 복사 // Copy Source Figure original
        flfaResult2 = CFLFigureArray(flfaSource2)
        ...
        print("Result1 Figure that vertexcount > 1 or area > 400 || (center.x > 300 || center.y < 100)\n")
        print(f"{CFigureUtilities.ConvertFigureObjectToString(flfaResult1)}\n\n")

        print("Source2 Figure Array\n")
        print(f"{CFigureUtilities.ConvertFigureObjectToString(flfaSource2)}\n\n")

        print("Result2 Figure that area >= mean('area')\n")
