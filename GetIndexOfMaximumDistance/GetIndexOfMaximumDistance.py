...
def main():
    ...
    while True:
        ...
        layerDst1.DrawTextCanvas(CFLPoint[Double](0, 20), "Index of Maximum Distance", EColor.CYAN, EColor.BLACK)
        layerDst2.DrawTextCanvas(CFLPoint[Double](0, 20), "Index of Maximum Distance", EColor.CYAN, EColor.BLACK)
