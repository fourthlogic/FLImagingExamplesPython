...
def main():
	...
	while True:
		...
		if (res := fliSourceImage.Load('../../ExampleImages/GammaCorrection/church.flif')).IsFail():
		...
		gammaCorrection = CGammaCorrection()

		# Source 이미지 설정 // Set the source image
		gammaCorrection.SetSourceImage(fliDestinationImage)

		# Destination 이미지 설정 // Set the destination image
		gammaCorrection.SetDestinationImage(fliDestinationImage)
