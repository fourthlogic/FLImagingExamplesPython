...
def main():
	...
	while True:
		...
		# 객체 생성 // Create object
		anisotropicDiffusion = CAnisotropicDiffusion()

		# Source 이미지 설정 // Set the source image
		anisotropicDiffusion.SetSourceImage(fliSourceImage)

		# Destination 이미지 설정 // Set the destination image
		anisotropicDiffusion.SetDestinationImage(fliDestinationImage)
