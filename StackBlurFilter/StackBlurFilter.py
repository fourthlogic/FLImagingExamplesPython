...
def main():
	...
	while True:
		...
		# Stack Blur Filter 객체 생성 # Create Stack Blur Filter object
		stackBlurFilter = CStackBlurFilter()

		# Source 이미지 설정 # Set the source image
		stackBlurFilter.SetSourceImage(fliSourceImage)

		# Destination 이미지 설정 # Set the destination image
		stackBlurFilter.SetDestinationImage(fliDestinationImage)
