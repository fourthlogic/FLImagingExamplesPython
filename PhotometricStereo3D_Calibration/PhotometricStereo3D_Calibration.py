...
def main():
	...
	while True:
		...
		if (res := photometricStereo3D.SetCalibrationCircleROI(CFLCircle[Double](117.210526, 104.842105, 78.736842, 0.000000, 0.000000, 360.000000, ERadialShapeType.Segment))).IsFail():
