...
def main():
	...
	while True:
		...
		if (res := fliSourceImage.Load('../../ExampleImages/Morphology/Chip_Noise.flif')).IsFail():
		...
		morphologyClose = CMorphologyClose()

		# Source 이미지 설정 # Set the source image
		morphologyClose.SetSourceImage(fliDestinationImage)

		# Destination 이미지 설정 # Set the destination image
		morphologyClose.SetDestinationImage(fliDestinationImage)
