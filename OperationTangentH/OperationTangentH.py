...
def main():
	...
	while True:
		...
		if (res := fliSourceImage.Load('../../ExampleImages/OperationTangentH/Moon.flif')).IsFail():
		...
		# 객체 생성 # Create object
		operationTangentH = COperationTangentH()

		# Source 이미지 설정 # Set source image
		operationTangentH.SetSourceImage(fliSourceImage)

		# Destination 이미지 설정 # Set destination image
		operationTangentH.SetDestinationImage(fliDestinationImage)
		...
		if (res := layerDestination.DrawTextCanvas(flpPoint, 'Destination Image', EColor.YELLOW, EColor.BLACK, 25)).IsFail():
			ErrorPrint(res, 'Failed to draw text.')
			break
