...
def main():
	...
	while True:
		...
		# 객체 생성 # Create object
		operationLogicalXor = COperationLogicalXor()

		# Source 이미지 설정 # Set the source image
		operationLogicalXor.SetSourceImage(fliSourceImage)

		# Destination 이미지 설정 # Set the destination image
		operationLogicalXor.SetDestinationImage(fliDestination1Image)
		...
		# Destination 이미지 설정 # Set the destination image
		operationLogicalXor.SetDestinationImage(fliDestination2Image)
		...
		if (res := layerSource.DrawTextCanvas(flpPoint, 'Source Image', EColor.YELLOW, EColor.BLACK, 20)).IsFail() or \
			(res := layerDestination1.DrawTextCanvas(flpPoint, 'Destination Image(LogicalXor 0)', EColor.YELLOW, EColor.BLACK, 20)).IsFail() or \
			(res := layerDestination2.DrawTextCanvas(flpPoint, 'Destination Image(LogicalXor 255)', EColor.YELLOW, EColor.BLACK, 20)).IsFail():
