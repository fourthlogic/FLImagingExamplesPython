...
def main():
	...
	while True:
		...
		# Contraharmonic Mean Filter 객체 생성 // Create Contraharmonic Mean Filter object
		contraharmonicMeanFilter = CContraharmonicMeanFilter()

		# Source 이미지 설정 // Set the source image
		contraharmonicMeanFilter.SetSourceImage(fliSourceImage)
