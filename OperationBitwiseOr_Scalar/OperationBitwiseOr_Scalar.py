...
def main():
	...
	while True:
		...
		if (res := layerSource.DrawTextCanvas(flpPoint, 'Source Image', EColor.YELLOW, EColor.BLACK, 30)).IsFail() or \
			(res := layerDestination1.DrawTextCanvas(flpPoint, 'Destination Image1(BitwiseOr 64)', EColor.YELLOW, EColor.BLACK, 30)).IsFail() or \
			(res := layerDestination2.DrawTextCanvas(flpPoint, 'Destination Image2(BitwiseOr 128)', EColor.YELLOW, EColor.BLACK, 30)).IsFail() :
