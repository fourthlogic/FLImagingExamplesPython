...
def main():
	...
	while True:
		...
		if (res := fliSourceImage.Load('../../ExampleImages/Threshold/Sun.flif')).IsFail():
		...
		# VarianceThreshold 객체 생성 // Create VarianceThreshold object
		varianceThreshold = CVarianceThreshold()

		# Source 이미지 설정 // Set the source image
		varianceThreshold.SetSourceImage(fliSourceImage)

		# Destination 이미지 설정 // Set the destination image
		varianceThreshold.SetDestinationImage(fliDestinationImage)
