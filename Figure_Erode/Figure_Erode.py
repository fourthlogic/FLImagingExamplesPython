...
def main():
    ...
    while True:
        ...
        layer[1].DrawTextCanvas(CFLPoint[Int32](0, 0), "Erode Result1", EColor.YELLOW, EColor.BLACK, 30)
        layer[2].DrawTextCanvas(CFLPoint[Int32](0, 0), "Erode Result2", EColor.YELLOW, EColor.BLACK, 30)
        layer[3].DrawTextCanvas(CFLPoint[Int32](0, 0), "Erode Result2", EColor.YELLOW, EColor.BLACK, 30)
