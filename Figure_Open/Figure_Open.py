...
def main():
    ...
    while True:
        ...
        if (res := flrgSourceFig.Open(i64KernelSize, i64KernelSize, flfaResult1))[0].IsFail():
        ...
        if (res := flrgSourceFig.Open(i64KernelSize, i64KernelSize, flfaResult2, EKernelShape.Circle))[0].IsFail():
            ErrorPrint(res[0], "Failed to calculate.")
            break
        ...
        if (res := flrgSourceFig.Open(fleKernel, flfaResult3))[0].IsFail():
            ErrorPrint(res[0], "Failed to calculate.")
            break
