...
def main():
    ...
    while True:
        ...
        layer[1].DrawTextCanvas(CFLPoint[Int32](0, 0), "Open Result1", EColor.YELLOW, EColor.BLACK, 30)
        layer[2].DrawTextCanvas(CFLPoint[Int32](0, 0), "Open Result2", EColor.YELLOW, EColor.BLACK, 30)
        layer[3].DrawTextCanvas(CFLPoint[Int32](0, 0), "Open Result2", EColor.YELLOW, EColor.BLACK, 30)
        ...
        res, flfaResult1 = flrgSourceFig.Open(i64KernelSize, i64KernelSize, flfaResult1)
        ...
        res, flfaResult2 = flrgSourceFig.Open(i64KernelSize, i64KernelSize, flfaResult2, EKernelShape.Circle)
        ...
        res, flfaResult3 = flrgSourceFig.Open(fleKernel, flfaResult3)
