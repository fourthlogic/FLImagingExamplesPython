...
def main():
	...
	flqROI1 = CFLQuad[float]();
	flqROI2 = CFLQuad[float]();
	flrROI3 = CFLRect[float]();
	...
	while True:
		...
		# 학습 정보 파일을 로드
		ocv.LoadFontData("../../ExampleImages/OCV/Font_A-Z_0-9.flocr")

		# 인식할 최소 퀄리티를 설정
		ocv.SetMinimumQuality(0.6)
