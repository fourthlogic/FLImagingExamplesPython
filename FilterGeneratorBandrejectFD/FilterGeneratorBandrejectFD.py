...
def main():
	...
	while True:
		...
		filterGeneratorBandrejectFD = CFilterGeneratorBandrejectFD()
		...
		# Destination 이미지 설정 // Set the destination image
		filterGeneratorBandrejectFD.SetDestinationImage(fliIdealFilterImage)
		...
		# Destination 이미지 설정 // Set the destination image
		filterGeneratorBandrejectFD.SetDestinationImage(fliGaussianFilterImage)
