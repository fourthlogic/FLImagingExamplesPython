...
def main():
	...
	while True:
		...
		if (res := fliSourceImage.Load('../../ExampleImages/Affine/Sea.flif')).IsFail():
		...
		# 객체 생성 # Create object
		rotationScale = CRotationScale()

		# Source 이미지 설정 # Set the source image
		rotationScale.SetSourceImage(fliSourceImage)

		# Destination 이미지 설정 # Set the destination image
		rotationScale.SetDestinationImage(fliDestinationImage)
