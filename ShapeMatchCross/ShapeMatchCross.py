...
def main():
    ...
    for i in range(i64ResultCount):
        ...
        print("  1. Shape Type : Cross")
        print("    Pivot X: {:.2f}".format(matchResult.flpPivot.x))
        print("    Pivot Y: {:.2f}".format(matchResult.flpPivot.y))
        print("    Half Length    : {:.2f}".format(matchResult.f64HalfLength))
        print("    Half Thickness    : {:.2f}".format(matchResult.f64HalfThickness))
