...
def main():
    ...
    shapeMatch = CShapeMatchRectangle()
    ...
    for i in range(i64ResultCount):
        ...
        print("  1. Shape Type : Rectangle")
        print("    Pivot X: {:.2f}".format(matchResult.flpPivot.x))
        print("    Pivot Y: {:.2f}".format(matchResult.flpPivot.y))
        print("    Width   : {:.2f}".format(matchResult.flrResultObject.GetWidth()))
        print("    Height   : {:.2f}".format(matchResult.flrResultObject.GetHeight()))
        print("    Angle   : {:.2f}".format(matchResult.flrResultObject.angle))
