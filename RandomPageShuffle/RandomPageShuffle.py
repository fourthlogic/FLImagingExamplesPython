...
def main():
	...
	while True:
		...
		# RandomPageShuffle 객체 생성 # Create RandomPageShuffle object
		...
		if (res := layerAfterSrc.DrawTextCanvas(flpPoint, 'Source Image After Shuffle', EColor.YELLOW, EColor.BLACK, 20)).IsFail():
			ErrorPrint(res, 'Failed to draw text.')
			break

		if (res := layerBeforeSrc.DrawTextCanvas(flpPoint, 'Source Image Before Shuffle', EColor.YELLOW, EColor.BLACK, 20)).IsFail():
			ErrorPrint(res, 'Failed to draw text.')
			break
