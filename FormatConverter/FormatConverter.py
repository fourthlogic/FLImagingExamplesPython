...
def main():
	...
	while True:
		...
		if (res := layerSource.DrawTextCanvas(flpPoint, 'Source Image(3Ch U8)', EColor.YELLOW, EColor.BLACK, 30)).IsFail() or \
			(res := layerDestination.DrawTextCanvas(flpPoint, 'Destination Image(1Ch U8)', EColor.YELLOW, EColor.BLACK, 30)).IsFail():
