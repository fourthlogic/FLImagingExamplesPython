...
def main():
	...
	while True:
		...
		adaptiveThresholdSauvola = CAdaptiveThresholdSauvola()

		# Source 이미지 설정 # Set source image 
		adaptiveThresholdSauvola.SetSourceImage(fliSrcImage)

		# Destination 이미지 설정 # Set destination image
		adaptiveThresholdSauvola.SetDestinationImage(fliDstImage)

		# 커널 사이즈 입력 # Set Kernel size 
		adaptiveThresholdSauvola.SetKernel(25, 25)

		# 임계값 옵셋 설정 # Set threshold offset 
		adaptiveThresholdSauvola.SetThresholdOffset(CMultiVar[Double](5))
