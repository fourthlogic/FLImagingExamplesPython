...
def main():
	...
	while True:
		...
		if (res := fliSourceImage.Load('../../ExampleImages/DiscreteCosineTransform/CircuitFocalBlur.flif')).IsFail():
		...
		# Discrete Cosine Transform 객체 생성 # Create Discrete Cosine Transform object
		discreteCosineTransform = CDiscreteCosineTransform()

		# Source 이미지 설정 # Set the source image
		discreteCosineTransform.SetSourceImage(fliSourceImage)

		# Destination 이미지 설정 # Set the destination image
		discreteCosineTransform.SetDestinationImage(fliDestinationImage)
