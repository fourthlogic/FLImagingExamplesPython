...
def main():
	...
	while True:
		...
		res = fliSourceImage.Load('C:/Users/junhy/source/repos/fourthlogic/ExampleImages/ChannelSwap/deer.flif')
		...
		res = viewImageSrc.Create(400, 0, 1052, 427)
		...
		res = viewImageDst.Create(1052, 0, 1692, 427)
