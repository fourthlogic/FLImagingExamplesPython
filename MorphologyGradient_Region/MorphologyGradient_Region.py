...
def main():
	...
	while True:
		...
		if (res := fliSourceImage.Load('../../ExampleImages/Morphology/CityNight.flif')).IsFail():
		...
		morphologyGradient = CMorphologyGradient()

		# Source 이미지 설정 // Set the source image
		morphologyGradient.SetSourceImage(fliDestinationImage)

		# Destination 이미지 설정 // Set the destination image
		morphologyGradient.SetDestinationImage(fliDestinationImage)
