...
def main():
	...
	while True:
		...
		# Coherence Enhancing Diffusion 객체 생성 # Create Coherence Enhancing Diffusion object
		coherenceEnhancingDiffusion = CCoherenceEnhancingDiffusion()

		# Source 이미지 설정 # Set the source image
		coherenceEnhancingDiffusion.SetSourceImage(fliSourceImage)

		# Destination 이미지 설정 # Set the destination image
		coherenceEnhancingDiffusion.SetDestinationImage(fliDestinationImage)
