...
def main():
    ...
    while True:
        ...
        if (res := fleResult2.Fit(flpaNoise, i64OutlierThresholdCount2, f64OutlierThreshold2, listOutlierIndices2))[0].IsFail():
        ...
        if (res := fleResult3.Fit(flpaNoise, i64OutlierThresholdCount3, f64OutlierThreshold3, listOutlierIndices3))[0].IsFail():
            ErrorPrint(res[0], "Failed to calculate.")
            break
