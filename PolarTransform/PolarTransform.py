...
def main():
	...
	while True:
		...
		if (res := fliSourceImage.Load('../../ExampleImages/PolarTransform/PolarTransformSrc.flif')).IsFail():
		...
		# Polar Transform 객체 생성 # Create Polar Transform object
		polarTransform = CPolarTransform()
