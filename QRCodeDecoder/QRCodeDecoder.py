...
def main():
    ...
    for i in range(i64Results):
        # QRCode Decoder 결과를 얻어오기 위해 FLQuadD 선언 # Declare FLQuadD to retrieve the result from the QRCode Decoder.
        flqRegion = CFLQuad[Double]()

        # QRCode Decoder 결과들 중 Data Region 을 얻어옴 # Gets the Data Region from the QRCode Decoder results.
        ...
        # QRCode Decoder 결과들 중 Decoded String 을 얻어옴 # Gets the decoded string from the results of the QRCode Decoder.
