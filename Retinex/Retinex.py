...
def main():
	...
	while True:
		...
		if (res := fliSourceImage.Load('../../ExampleImages/Retinex/wall.flif')).IsFail():
		...
		mvMinRange = CMultiVar[Double](0.000000)
		mvMaxRange = CMultiVar[Double](255.000000)
		...
		mvMinRatio = CMultiVar[Double](0.010000)
		mvMaxRatio = CMultiVar[Double](0.010000)
