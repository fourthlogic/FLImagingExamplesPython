...
def main():
	...
	while True:
		...
		# 객체 생성 # Create object
		flDenoisingType2 = CFLDenoisingType2()

		# Source 이미지 설정 # Set the source image
		flDenoisingType2.SetSourceImage(fliSourceImage)

		# Destination 이미지 설정 # Set the destination image
		flDenoisingType2.SetDestinationImage(fliDestinationImage)

		# Kernel 크기 설정 # Set the Kernel Size
		flDenoisingType2.SetKernel(3)

		# Amplitude 설정 # Set the Amplitude
		flDenoisingType2.SetAmplitude(0.2)

		# Operation Mode 설정 # Set the Operation Mode
		flDenoisingType2.SetOperationMode(CFLDenoisingType2.EOperationMode.Fast)
