...
def main():
	...
	while True:
		...
		if(bAutoDetect):
			...
			er = camMechEye.GetAutoDetectCameraSerialNumbers(listSerialNumbers)
		...
		if(bAutoDetect):
			...
			if((er := camMechEye.AutoDetectCamera(i32SelectDevice)).IsFail()):
		...
		if((er := camMechEye.Initialize()).IsFail()):
