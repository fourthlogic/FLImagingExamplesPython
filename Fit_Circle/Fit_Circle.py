...
def main():
    ...
    while True:
        ...
        flc = CFLCircle[Double](250, 250, 150)
        ...
        layer[0].DrawTextImage(flcResult1.GetCenter(), f"Center : ({flcResult1.GetCenter().x:.3f}, {flcResult1.GetCenter().y:.3f})\r\nRadius : {flcResult1.GetRadius():.3f}", EColor.YELLOW, EColor.BLACK, 13, False, 0.0, EGUIViewImageTextAlignment.CENTER_CENTER)


        flcResult2 = CFLCircle[Double]()
        ...
        res, listOutlierIndices2 = flcResult2.Fit(flpaNoise, i64OutlierThresholdCount2, f64OutlierThreshold2, listOutlierIndices2)
        ...
        layer[1].DrawTextImage(flcResult2.GetCenter(), f"Center : ({flcResult2.GetCenter().x:.3f}, {flcResult2.GetCenter().y:.3f})\r\nRadius : {flcResult2.GetRadius():.3f}", EColor.YELLOW, EColor.BLACK, 13, False, 0.0, EGUIViewImageTextAlignment.CENTER_CENTER)

        flcResult3 = CFLCircle[Double]()
        ...
        res, listOutlierIndices3 = flcResult3.Fit(flpaNoise, i64OutlierThresholdCount3, f64OutlierThreshold3, listOutlierIndices3)
        ...
        layer[2].DrawTextImage(flcResult3.GetCenter(), f"Center : ({flcResult3.GetCenter().x:.3f}, {flcResult3.GetCenter().y:.3f})\r\nRadius : {flcResult3.GetRadius():.3f}", EColor.YELLOW, EColor.BLACK, 13, False, 0.0, EGUIViewImageTextAlignment.CENTER_CENTER)
