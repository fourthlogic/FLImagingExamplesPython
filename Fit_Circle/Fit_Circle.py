...
def main():
    ...
    while True:
        ...
        if (res := flcResult2.Fit(flpaNoise, i64OutlierThresholdCount2, f64OutlierThreshold2, listOutlierIndices2))[0].IsFail():
        ...
        if (res := flcResult3.Fit(flpaNoise, i64OutlierThresholdCount3, f64OutlierThreshold3, listOutlierIndices3))[0].IsFail():
            ErrorPrint(res[0], "Failed to calculate.")
            break
