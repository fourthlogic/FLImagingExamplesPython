...
def main():
	...
	while True:
		...
		if (res := fliSourceImage.Load('../../ExampleImages/OperationMatrixMultiply/Matrix0.flif')).IsFail():
		...
		operationMatrixMultiply.SetSourceImage(fliSourceImage)

		# Destination 이미지 설정 # Set the destination image
		operationMatrixMultiply.SetDestinationImage(fliDestinationImages[0])
		...
		# Destination 이미지 설정 # Set the destination image
		operationMatrixMultiply.SetDestinationImage(fliDestinationImages[1])
