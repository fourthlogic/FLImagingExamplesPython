...
def main():
	...
	while True:
		...
		laplacianVariance = CLaplacianVariance()
		
		# Source 이미지 1 설정 # Set the source1 image
		laplacianVariance.SetSourceImage(fliSourceImage1)
		...
		f64Score1 = laplacianVariance.GetResultScore()

		# Source 이미지 2 설정 # Set the source2 image
		laplacianVariance.SetSourceImage(fliSourceImage2)
		...
		# 결과 점수 획득 # Get Result Score
		f64Score2 = laplacianVariance.GetResultScore()

		# Source 이미지 3 설정 # Set the source3 image
		laplacianVariance.SetSourceImage(fliSourceImage3)
		...
		# 결과 점수 획득 # Get Result Score
		f64Score3 = laplacianVariance.GetResultScore()
