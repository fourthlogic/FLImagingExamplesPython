...
def main():
	...
	while True:
		...
		generativeAdversarialNetworkDL.SetInferenceResultImage(fliResultImage)
		...
		while viewImageLearn.IsAvailable() and viewImageResult.IsAvailable() and viewImageValidate.IsAvailable() and viewGraph.IsAvailable():
