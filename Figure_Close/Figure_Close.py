...
def main():
    ...
    while True:
        ...
        res, flfaResult1 = flrgSourceFig.Close(i64KernelSize, i64KernelSize, flfaResult1)
        ...
        res, flfaResult2 = flrgSourceFig.Close(i64KernelSize, i64KernelSize, flfaResult2, EKernelShape.Circle)
        ...
        res, flfaResult3 = flrgSourceFig.Close(fleKernel, flfaResult3)
