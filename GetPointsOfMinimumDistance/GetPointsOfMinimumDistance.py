...
def main():
    ...
    while True:
        ...
        layerDst1.DrawTextCanvas(CFLPoint[Double](0, 20), "Minimum Distance", EColor.CYAN, EColor.BLACK)
        layerDst2.DrawTextCanvas(CFLPoint[Double](0, 20), "Minimum Distance", EColor.CYAN, EColor.BLACK)
        ...
        layerDst1.DrawTextImage(fllMin1.GetCenter(), f"{f64MinimumDistance1:.3f}", EColor.CYAN, EColor.BLACK, 12, False, 0.0, EGUIViewImageTextAlignment.RIGHT_TOP)
        ...
        layerDst2.DrawTextImage(fllMin2.GetCenter(), f"{f64MinimumDistance2:.3f}", EColor.CYAN, EColor.BLACK, 12, False, 0.0, EGUIViewImageTextAlignment.LEFT_BOTTOM)
