...
def main():
	...
	while True:
		...
		lanczosSplineWarping.SetSourceImage(fliSourceImage[0])

		# Destination 이미지 설정 // Set the destination image
		lanczosSplineWarping.SetDestinationImage(fliDestinationImage[0])
		...
		for k in range(flpaSource.GetCount()):
			...
			if((res := lanczosSplineWarping.Calibrate()).IsFail()):
		...
		# Source 이미지 설정 // Set the source image
		lanczosSplineWarping.SetSourceImage(fliSourceImage[1])
		# Destination 이미지 설정 // Set the destination image
		lanczosSplineWarping.SetDestinationImage(fliDestinationImage[1])
		# Interpolation Method 설정 // Set the interpolation method
		lanczosSplineWarping.SetInterpolationMethod(EInterpolationMethod.Bilinear)
