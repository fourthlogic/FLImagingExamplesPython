...
def main():
	...
	while True:
		...
		sumModifiedLaplacian = CSumModifiedLaplacian()
		
		# Source 이미지 1 설정 # Set the source1 image
		sumModifiedLaplacian.SetSourceImage(fliSourceImage1)
		...
		f64Score1 = sumModifiedLaplacian.GetResultScore()

		# Source 이미지 2 설정 # Set the source2 image
		sumModifiedLaplacian.SetSourceImage(fliSourceImage2)
		...
		# 결과 점수 획득 # Get Result Score
		f64Score2 = sumModifiedLaplacian.GetResultScore()

		# Source 이미지 3 설정 # Set the source3 image
		sumModifiedLaplacian.SetSourceImage(fliSourceImage3)
		...
		# 결과 점수 획득 # Get Result Score
		f64Score3 = sumModifiedLaplacian.GetResultScore()
