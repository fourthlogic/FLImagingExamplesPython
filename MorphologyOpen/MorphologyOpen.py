...
def main():
	...
	while True:
		...
		if (res := fliSourceImage.Load('../../ExampleImages/Morphology/Chip_Noise2.flif')).IsFail():
		...
		morphologyOpen = CMorphologyOpen()

		# Source 이미지 설정 // Set the source image
		morphologyOpen.SetSourceImage(fliDestinationImage)

		# Destination 이미지 설정 // Set the destination image
		morphologyOpen.SetDestinationImage(fliDestinationImage)
