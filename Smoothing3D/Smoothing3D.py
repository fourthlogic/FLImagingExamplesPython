...
def main():
	...
	fl3DODestinationObject = CFL3DObject()
	fl3DOSourceObject = CFL3DObject()
	...
	while True:		
		...
		if(res := fl3DOSourceObject.Load("../../ExampleImages/Smoothing3D/Smoothing3DExample.ply")).IsFail() :		
		...
		if(res := view3DSource.PushObject(fl3DOSourceObject)).IsFail() :		
		...
		smoothing3D.SetAutoSigmaCoefficient(4)
		...
		if(res := view3DDst.PushObject(smoothing3D.GetDestinationObject())).IsFail() :		
