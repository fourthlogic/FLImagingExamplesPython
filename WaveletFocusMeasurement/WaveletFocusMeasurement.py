...
def main():
	...
	while True:
		...
		# WaveletFocusMeasurement 객체 생성 # Create WaveletFocusMeasurement object
		waveletFocusMeasurement = CWaveletFocusMeasurement()
		
		# Source 이미지 1 설정 # Set the source1 image
		waveletFocusMeasurement.SetSourceImage(fliSourceImage1)
		...
		f64Score1 = waveletFocusMeasurement.GetResultScore();

		# Source 이미지 2 설정 # Set the source2 image
		waveletFocusMeasurement.SetSourceImage(fliSourceImage2)
		...
		# 결과 점수 획득 # Get Result Score
		f64Score2 = waveletFocusMeasurement.GetResultScore();
		...
		while viewImageSrc1.IsAvailable() and viewImageSrc2.IsAvailable():
