...
def main():
	...
	while True:
		...
		# Auto Correlation FD 객체 생성 // Create Auto Correlation FD object
		autoCorrelationFD = CAutoCorrelationFD()

		# Source 이미지 설정 // Set the source image
		autoCorrelationFD.SetSourceImage(fliSourceImage)

		# Destination 이미지 설정 // Set the destination image
		autoCorrelationFD.SetDestinationImage(fliDestinationImage)
		...
		if (res := autoCorrelationFD.Execute()).IsFail():
			ErrorPrint(res, 'Failed to execute Auto Correlation FD.')
			break
