...
def main():
	...
	while True:
		...
		if (res := fliSourceImage.Load('../../ExampleImages/TextureFilter/Owl.flif')).IsFail():
		...
		# 객체 생성 // Create object
		textureFilter = CTextureFilter()

		# Source 이미지 설정 // Set the source image
		textureFilter.SetSourceImage(fliSourceImage)

		# Destination 이미지 설정 // Set the destination image
		textureFilter.SetDestinationImage(fliDestinationImage)
