...
def main():
	...
	while True:
		...
		if (res := fliSourceImage.Load('../../ExampleImages/Histogram/Mountain.flif')).IsFail():
		...
		adaptiveEqualization = CAdaptiveEqualization()

		# Source 이미지 설정 // Set the source image
		adaptiveEqualization.SetSourceImage(fliSourceImage)

		# Destination 이미지 설정 // Set the destination image
		adaptiveEqualization.SetDestinationImage(fliDestinationImage)
