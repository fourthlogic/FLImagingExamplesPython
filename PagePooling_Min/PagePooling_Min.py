...
def main():
	...
	while True:
		...
		#	- Min : 입력된 이미지 가운데 최대 값을 출력합니다. // Min : Outputs the maximum value of the entered image.
		#	- MinGaussian : 입력된 이미지 가운데 가장 앞 쪽 인덱스에 위치한 최대 값을 기준으로 가우시안 값을 출력합니다. // MinGaussian : Outputs the Gaussian value based on the maximum value located in the leading index of the entered image.
