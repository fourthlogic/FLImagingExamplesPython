...
def main():
	...
	while True:
		...
		if (res := fliSourceImage.Load('../../ExampleImages/DiscreteSineTransform/CircuitFocalBlur.flif')).IsFail():
		...
		# Discrete Sine Transform 객체 생성 // Create Discrete Sine Transform object
		discreteSineTransform = CDiscreteSineTransform()

		# Source 이미지 설정 // Set the source image
		discreteSineTransform.SetSourceImage(fliSourceImage)

		# Destination 이미지 설정 // Set the destination image
		discreteSineTransform.SetDestinationImage(fliDestinationImage)
