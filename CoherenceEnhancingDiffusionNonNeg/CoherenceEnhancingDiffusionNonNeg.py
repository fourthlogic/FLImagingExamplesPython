...
def main():
	...
	while True:
		...
		if (res := fliSourceImage.Load('../../ExampleImages/CoherenceEnhancingDiffusion/fingerprint.flif')).IsFail():
		...
		# Coherence Enhancing Diffusion Non Neg 객체 생성 // Create Coherence Enhancing Diffusion Non Neg object
		coherenceEnhancingDiffusionNonNeg = CCoherenceEnhancingDiffusionNonNeg()

		# Source 이미지 설정 // Set the source image
		coherenceEnhancingDiffusionNonNeg.SetSourceImage(fliSourceImage)

		# Destination 이미지 설정 // Set the destination image
		coherenceEnhancingDiffusionNonNeg.SetDestinationImage(fliDestinationImage)
